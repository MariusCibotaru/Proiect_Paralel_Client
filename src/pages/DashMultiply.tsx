    ...
    <Box sx={{
      ...
      gap: 2
        ...
        <Box sx={{
            ...
            >
                Trimiteți două matrici — iar noi calculăm operațiile pentru dumneavoastră
            </Typography>
            ...
            >
                - Înmulțirea matricilor dacă dimensiunile sunt compatibile  
                - Adunarea și Scăderea dacă ambele au aceeași dimensiune  
            </Typography>
            ...
            >
                * Se acceptă doar fișiere .txt • Maxim 10×10 per matrice • Matricile trebuie separate prin linie cu #
            </Typography>
        </Box>
        ...
        <Box sx={{
            ...
            >
            <Typography variant="body2" sx={{ whiteSpace: 'pre-line', color: '#ccc', mb: 2 }}>
                {'• Format fișier acceptat: .txt\n' +
                '• Matricele trebuie separate prin linie cu #\n\n' +
                'Exemplu:\n' +
                '1 2 3 4\n' +
                '4 5 6 6\n' +
                '3 5 6 3\n' +
